function HomeButtons() {
    ...
    return (
        <div className="flex flex-col sm:items-center items-start sm:flex-row gap-5 mt-10">

                    <button onClick={gotoContact} className="flex md:w-[300px] max-w-[200px] rounded-full justify-center text-[16px] font-bold sm:text-[20px] gap-2 p-2 
                    hover:bg-white hover:border-2 border-[#ffdf60]  h-[47px] items-center bg-[#FFDF60]">
                        <img src="images/icon-mail.png" alt="" />Contact Me
                    </button>

                    <button onClick={createDownload} className="flex font-bold md:w-[300px] text-[16px] sm:text-[20px] max-w-[200px] group rounded-full hover:border-[#a46666]
                     hover:bg-white border-2 hover:text-black justify-center  gap-2 p-3 h-[47px] items-center text-white bg-[#FF6464]">Download CV
                        {/* black svg */}
                        <svg className="hidden group-hover:block" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* white svg */}
                        <svg className="group-hover:hidden block" width="30px"height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" >
